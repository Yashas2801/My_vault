...
For this part of DDR learning, the most important focus is inside a bank:
...
When a bank is activated, one full row in that bank becomes active. This is the bridge between DRAM cell physics and DDR command behavior. This topic is specifically about learning rows, columns, wordlines, bitlines, sense amplifiers, row buffer, and open-row behavior. 
